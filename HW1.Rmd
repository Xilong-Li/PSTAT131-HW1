...
Usually, Mechanistic model has more flexibility than empirical model, since mechanistic model can add parameters. Therefore, since more flexibility usually means less interpretability and sometimes more error, I think empirically-driven model is easier to understand.
...
1) displ has positive correlation with cyl;
2) displ has negative correlation with cty;
3) displ has negative correlation with hwy;
4) cyl has negative correlation with cty;
5) cyl has negative correlation with hwy;
6) cty has positive correlation with hwy;
